...
"%CSC%" /nologo /target:winexe /optimize+ /platform:anycpu /out:"%~dp0TF2_STV_Parser_GUI.exe" /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Web.Extensions.dll "%~dp0gui\Program.cs"
if errorlevel 1 goto :fail
echo.
echo BUILD PASSED
